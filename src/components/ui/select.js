...
const SelectTrigger = (({ className, children}, ref) => (
...
const SelectContent = (({ className, children, position = 'popper'}, ref) => (
...
const SelectLabel = (({ className }, ref) => (
...
const SelectItem = (({ className, children}, ref) => (
...
const SelectSeparator = (({ className }, ref) => (
